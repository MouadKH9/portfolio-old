      ...
      <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="add.php" class="waves-effect"><i class="fa  fa-fw fa-plus-circle" aria-hidden="true"></i>Add a project</a>
                    </li>
          ...
          <div class="row">
                  ...
                  <div class="overlay-box">
                    <div class="user-content">
                      <a href="javascript:void(0)"
                        ><img
                          src="<?php echo $config['image'] ?>"
                          class="thumb-lg img-circle"
                          alt="img"
                      /></a>
                      <h4 id="span-username" class="text-white"><?php echo $config['username']?></h4>
                      <h5 id="span-description" class="text-white"><?php echo $config['description']?></h5>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-8 col-xs-12">
              <div class="white-box">
                <form
                  method="POST"
                  action="../php/ops.php?updateProfile=1"
                ...
                >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                    <input style="display:none" type="file" name="image" id="file-1" accept="image/*" class="inputfile inputfile-1" data-multiple-caption="{count} files selected"/>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <textarea
                        ...
                        rows="5"
                        class="form-control form-control-line"
                      ><?php echo $config['about']?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-12">
